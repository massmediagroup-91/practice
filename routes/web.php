...
Route::middleware(['auth'])->group(function() {
    ...
    Route::get('/generate-link/{id}', 'GenearteController@generateStaticLink')->name('file.static.generate');
    Route::get('/disposable-link/{id}', 'GenerateController@generateDisposableLink')->name('file.disposable.generate');
    Route::get('/report', 'ReportController@index')->name('file.report');
});

Route::get('/record/{token}', 'FindLinkController@findStaticLink')->name('check.static.link');
Route::get('/record/disposable/{token}', 'FindLinkController@DisposableLink')->name('check.disposable.link');
